...
print("Cogemos solo las FILAS con la antiguedad=" + antiguedad + " y con TARGET PREDICHO=1...")
...
if (num_filas == 0):
    ...
    filasFiltradas.sort_values(by='TARGET_PREDICHO_PROB', ascending=False).to_csv(pathSalidaManejable, index=False,
                                                                                  sep='|')
