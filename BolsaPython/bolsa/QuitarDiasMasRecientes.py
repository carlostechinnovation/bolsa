...
#EXPLICACION
# Se toma el fichero de entrada (se asume que es el COMPLETO.csv de un subgrupo,
...
print("--- QuitarDiaDeCompleto: INICIO ---")
...
filasFiltradas.to_csv(dirSalida+nombreFicheroSalida, index=False, sep='|')  # Solo se guarda el GRANDE del subgrupo 0


print("--- QuitarDiaDeCompleto: FIN ---")