...
public class BrutosUtils implements Serializable {
	...
	public static final String NASDAQ_TICKERS_CSV_INVERTIDOS = "src/main/resources/nasdaq_tickers_invertidos_v3.csv";
	public static final String NASDAQ_TICKERS_CSV_ACTIVAS = "src/main/resources/nasdaq_activas_v3.csv";
	...
	public static final int INFO_MOSTRAR_CADA_X_EMPRESAS = 25;
