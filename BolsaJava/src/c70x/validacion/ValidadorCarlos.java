...
@Deprecated
public class ValidadorCarlos implements Serializable {

	private static final long serialVersionUID = 1L;

	static Logger MY_LOGGER = Logger.getLogger(Validador.class);

	private static ValidadorCarlos instancia = null;

	private static String DEFINICION_PREDICCION = "COMPLETO_PREDICCION.csv";

	private ValidadorCarlos() {
		super();
	}

	public static ValidadorCarlos getInstance() {
		if (instancia == null)
			instancia = new ValidadorCarlos();
